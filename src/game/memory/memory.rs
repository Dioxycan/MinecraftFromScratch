...
// impl Memory{
//     pub fn new(core:Rc<Core>,memory_type_index:u32,allocation_size:vk::DeviceSize)->Self{
//         let buffer = unsafe{
...
//             core.logical_device.allocate_memory(&allocate_info, None).expect("Failed to allocate memory")
